 ...
 */
class UploadCsvRepository extends ServiceEntityRepository
{
    ...
    // /**
    //  * @return UploadCsv[] Returns an array of UploadCsv objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?UploadCsv
    {
        return $this->createQueryBuilder('u')
            ->andWhere('u.exampleField = :val')
            ->setParameter('val', $value)
